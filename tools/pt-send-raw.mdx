...
```javascript
lwAddDevice("MGMT-PC", 8, "PC-PT", 700, 500); lwAddLink("SW1", "FastEthernet0/24", "MGMT-PC", "FastEthernet0", "straight")
```
...
| `lwAddLink(d1, p1, d2, p2, cable)` | Add a cable to logical canvas (patched helper) |
