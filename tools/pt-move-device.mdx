---
title: "pt_move_device: Reposition a Device on the PT Canvas"
sidebarTitle: "Move Device"
description: "pt_move_device repositions a named device to new x,y canvas coordinates in the active Packet Tracer topology via the HTTP bridge on port 54321."
---
