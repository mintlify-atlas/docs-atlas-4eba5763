...
sidebarTitle: "Rename Device"
description: "pt_rename_device changes a device's display name in the active Packet Tracer topology via the bridge, without removing it or its connections."
---
