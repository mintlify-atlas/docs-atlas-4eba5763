---
title: "Topology Templates Reference"
sidebarTitle: "Templates"
description: "Reference for all 9 topology templates in MCP Packet Tracer — single_lan, multi_lan, star, hub_spoke, branch_office, and more — with default parameters."
---
...
| `hub_spoke` | Hub and Spoke | 1 hub router + N spoke routers, each with a LAN | eigrp | 1 | 20 | 4 |
...
One hub router at the centre with N spoke routers connected directly to it. Each spoke has its own switch and LAN. The default routing protocol is **EIGRP** because hub-and-spoke is a classic EIGRP scenario in CCNA/CCNP labs. Default: 4 routers total (1 hub + 3 spokes), 2 PCs per LAN.
...
Include the `template` key in your `pt_plan_topology` or `pt_full_build` call:
